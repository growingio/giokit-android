...
public class NotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(GioKitImpl.APPLICATION).areNotificationsEnabled();
    }
     ...
     */
    public static void notify(int id, NotifyBuilder<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, NotifyBuilder<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, NotifyBuilder<NotificationCompat.Builder> consumer) {
    ...
    public static Notification getNotification(ChannelConfig channelConfig, NotifyBuilder<NotificationCompat.Builder> consumer) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) GioKitImpl.APPLICATION.getSystemService(Context.NOTIFICATION_SERVICE);
            //noinspection ConstantConditions
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationCompat.Builder builder = new NotificationCompat.Builder(GioKitImpl.APPLICATION);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(GioKitImpl.APPLICATION).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(GioKitImpl.APPLICATION).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(GioKitImpl.APPLICATION).cancelAll();
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = GioKitImpl.APPLICATION.getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                GioKitImpl.APPLICATION.getPackageName(), GioKitImpl.APPLICATION.getPackageName(), IMPORTANCE_DEFAULT
        );

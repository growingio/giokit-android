...
class GioInjectTransformer : ClassTransformer {
    ...
    private fun createPluginConfigInsnList(): InsnList {
        return with(InsnList()) {
            ...
            add(InsnNode(if (GioConfigUtils.hasGioPluginSaas) Opcodes.ICONST_1 else Opcodes.ICONST_0))
            add(
                MethodInsnNode(
                    Opcodes.INVOKESTATIC,
                    "java/lang/Boolean",
            ...
            add(LdcInsnNode(GioConfigUtils.saasXmlScheme))
            add(
                MethodInsnNode(
                    Opcodes.INVOKEINTERFACE,
                    "java/util/Map",
            ...
            add(LdcInsnNode(GioConfigUtils.getGioDepend(GioConfigUtils.gioSaasSdks)))
            add(
                MethodInsnNode(
                    Opcodes.INVOKEINTERFACE,
                    "java/util/Map",

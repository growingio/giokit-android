...
import com.growingio.giokit.plugin.utils.GioConfigUtils.gioV3Sdks
 ...
 */
class GioKitV3ConfigProcessor(val project: Project) : VariantProcessor {
    ...
    override fun process(variant: BaseVariant) {
        ...
        for (dependLib in dependLibs) {
            ...
            if (dependLib.variant.contains("com.growingio.android")
                ...
                gioV3Sdks.add(dependLib)
                "add gio dependLib:${dependLib}".println()
            }
        }

        if (variant is ApplicationVariant) {
            GioConfigUtils.v3Domain = variant.applicationId
            "App PackageName is====>${variant.applicationId}".println()
        ...
        GioConfigUtils.hasGioPluginV3 =
            project.plugins.hasPlugin("com.growingio.android.autotracker")
    }
}